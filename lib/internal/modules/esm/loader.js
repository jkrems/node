...
class Loader {
  ...
  async resolve(specifier, parentURL) {
    ...
    const resolved = bottomLoaderRPC ? await bottomLoaderRPC.send({
      specifier,
      base: parentURL
...
exports.initUserLoaders = function (asyncBottomLoader) {
  if (!asyncBottomLoader) return;
  const bottomLoader = (async () => {
    const port = await asyncBottomLoader;
  })()
